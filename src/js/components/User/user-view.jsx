...
export class UserView extends React.Component {
  ...
  getUser = () => {
    ...
    axios
      .get(`https://sleepy-brook-50846.herokuapp.com/users/${username}`, {
  ...
  updateUser = (e) => {
    ...
    axios
      .put(
        `https://sleepy-brook-50846.herokuapp.com/users/${username}`,
        {
  ...
  deleteUser = (e) => {
    ...
    if (confirmDelete) {
      ...
      const token = localStorage.getItem("token");
      axios
        .delete(`https://sleepy-brook-50846.herokuapp.com/users/${username}`, {
          headers: { Authorization: `Bearer ${token}` },
        })
        .then(() => {
  ...
  removeFavoriteMovie = (movieId) => {
    ...
    axios
      .delete(
        `https://sleepy-brook-50846.herokuapp.com/users/${username}/movies/${movieId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      )
